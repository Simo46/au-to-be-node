...
/**
 * Validazioni per le rotte di gestione impianti tecnologici
 */
const impiantoValidators = {
  /**
   * Validazioni per la creazione di un impianto tecnologico
  ...
  createImpianto: [
    ...
    body('tipo_alimentazione_id')
      .optional()
      .isUUID().withMessage('L\'ID del tipo alimentazione deve essere un UUID valido'),
  ...
  /**
   * Validazioni per l'aggiornamento di un impianto tecnologico
   */
  updateImpianto: [
    body('categoria_id')
      .optional()
  ...
  /**
   * Validazioni per la creazione combinata di asset e impianto tecnologico
   */
  createCombined: [
    // Campi asset base
    body('code')
    ...
    // Campi specifici impianto tecnologico
    body('categoria_id')
      .optional()
      .isUUID().withMessage('L\'ID della categoria deve essere un UUID valido'),
...
module.exports = impiantoValidators;