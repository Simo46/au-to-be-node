...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    console.log('Funzione track_entity_changes aggiornata con successo.');
  },

  async down(queryInterface, Sequelize) {
    // Ripristina la vecchia versione della funzione
    await queryInterface.sequelize.query(`
      CREATE OR REPLACE FUNCTION public.track_entity_changes()
      RETURNS trigger
      LANGUAGE plpgsql
    ...
    console.log('Funzione track_entity_changes ripristinata alla versione precedente.');
  }
};